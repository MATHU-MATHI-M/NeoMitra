      ...
      <Container>
        <Row className="align-items-center py-4">
          <Col md={4} className="text-center text-md-start mb-3 mb-md-0">
            <div className="footer-brand">
              <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className="footer-icon">
            ...
            <p className="mb-0 mt-2 footer-tagline">Empowering maternal health in every village</p>
          </Col>
          
          <Col md={4} className="text-center mb-3 mb-md-0">
            <h5 className="footer-heading">Supported Languages</h5>
            <div className="languages">
              ...
              <span className="language-badge">Telugu</span>
              <span className="language-badge">Bengali</span>
            </div>
          </Col>
        ...
        <Row>
          <Col className="text-center py-3">
            <p className="mb-0 copyright">© {currentYear} NeoMitra. All rights reserved.</p>
          </Col>
        </Row>
      </Container>
    </footer>
